    ...
    <div class="main_container main_container--home" >
        ...
        <div class="page_container page_container--home">
            <div class="main_content main_content--home">
                <div class="main_content__image main_content__image--home" style="background-image: url('{{asset('storage/images/home/'.$home->getRecipes()['image'])}}')"></div>
                <div class="main_content__text main_content__text--home" >
                    <div class="text">{{$home->getRecipes()['content']}}</div>
                    <a href="/ricette">Scopri tutte le ricette</a>
                </div>
            </div>
            <div class="main_content main_content--home">
                <div class="main_content__image main_content__image--home" style="background-image: url('{{asset('storage/images/home/'.$home->getIngredients()['image'])}}')"></div>
                <div class="main_content__text main_content__text--home" >
            ...
            <div class="main_content main_content--home">
                <div class="main_content__image main_content__image--home" style="background-image: url('{{asset('storage/images/home/'.$home->getAboutMe()['image'])}}')"></div>
                <div class="main_content__text main_content__text--home">
